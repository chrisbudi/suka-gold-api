...
class gold_price_config(models.Model):
    ...
    gold_price_setting_model_buy_weekday = models.CharField() # base_price + 10 (additionalPrice) + 10 (additional2) + 10(additional3)
    gold_price_setting_model_sell_weekday = models.CharField() # base_price + 10 (additionalPrice) + 10 (additional2) + 10(additional3)
    gold_price_setting_model_buy_weekend = models.CharField() # base_price + 10 (additionalPrice) + 10 (additional2) + 10(additional3)
    gold_price_setting_model_sell_weekend = models.CharField() # base_price + 10 (additionalPrice) + 10 (additional2) + 10(additional3)
    ...
    def calculate_price(self, types: str, base_price: decimal.Decimal) -> decimal.Decimal:   
        switch= {
