...
urlpatterns = [
    ...
    path('educational', views_educational.InformationEducationViewSet.as_view({'get': 'list'}), name='list_educational'),
    path('educational', views_educational.InformationEducationViewSet.as_view({'post': 'create'}), name='post_educational'),
    path('educational/<int:pk>', views_educational.InformationEducationViewSet.as_view({'patch': 'update'}), name='patch_educational'),
    path('educational/<int:pk>', views_educational.InformationEducationViewSet.as_view({'delete': 'destroy'}),  name='delete_educational'),
    path('educational/<int:pk>', views_educational.InformationEducationViewSet.as_view({'get': 'retrieve'}), name='get_educational'),  
    
    # path('create_educational', views_educational.EducationalAPIView.post, name='create_educational'),
    # path('update_educational/<int:id>', views_educational.EducationalAPIView.patch, name='update_educational'),
