...
class paxel_service:
    ...
    def __init__(self):
        ...
        self.headers = {
            ...
            "API_Key": paxel_conf["API_KEY"],
        }

    def generate_payload(
        self, address: user_address, order_amount: Decimal, service_name: str
    ) -> dict:
        """Generate payload for Paxel service."""
        ...
        payload = {
            ...
            "weight": 1,
            "dimension": "1x1x1",
            "service_type": service_name,  # e.g., "same_day", "next_day"
        }
        return payload
