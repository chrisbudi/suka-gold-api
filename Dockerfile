...
CMD ["sh", "-c", "nginx && granian --interface asginl --host 0.0.0.0 --ssl-certificate /etc/letsencrypt/live/nemas.id/fullchain.pem --ssl-keyfile /etc/letsencrypt/live/nemas.id/privkey.pem --port 8000 app.asgi:application "]